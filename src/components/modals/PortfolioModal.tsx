                                    ...
                                    {isPdf ? (
                                        ...
                                        >
                                            <div className="flex flex-col items-center justify-center h-full">
                                                ...
                                                <a href={currentDocumentUrl} target="_blank" rel="noopener noreferrer" className="font-bold" style={{ color: DYNAMIC_COLORS.raw.light.primary }}>{t.downloadPdf}</a>
                                            </div>
                                        </iframe>
                                    )}
                                </div>
